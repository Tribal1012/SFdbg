...
#define TotalSection(x, y) x*y

// Section Header & Data
typedef struct _IMAGE_SECTION_ALL {
    SECTION_HEADER psh;
    char* shdata;
}IMAGE_SECTION_ALL, *PIMAGE_SECTION_ALL;

//PE File Format
typedef struct _PE_Format {
    DOS_HEADER idh;
    NT_HEADERS inh;
    PIMAGE_SECTION_ALL psa;         //포인터로 선언했을 뿐... 내용물이 없음
